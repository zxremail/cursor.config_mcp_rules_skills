...
- <a id="toc-pos-1-补充文档内目录cli优先于手写"></a>[6. 1. 补充文档内目录（CLI，优先于手写）](#1-补充文档内目录cli优先于手写)
  - <a id="toc-pos-目录--文档标题"></a>[6.1. 目录 • 文档标题](#目录--文档标题)
- <a id="toc-pos-2-同步-_index_md"></a>[7. 2. 同步 `_INDEX_.md`](#2-同步-_index_md)
- <a id="toc-pos-3-推荐执行顺序"></a>[8. 3. 推荐执行顺序](#3-推荐执行顺序)
- <a id="toc-pos-4-自动-hook用户级"></a>[9. 4. 自动 Hook（用户级）](#4-自动-hook用户级)
- <a id="toc-pos-5-何时可跳过"></a>[10. 5. 何时可跳过](#5-何时可跳过)

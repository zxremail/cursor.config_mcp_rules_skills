...
- <a id="toc-pos-安装路径"></a>[1. 安装路径](#安装路径)
- <a id="toc-pos-用法"></a>[2. 用法](#用法)
- <a id="toc-pos-行为"></a>[3. 行为](#行为)
- <a id="toc-pos-双向跳转"></a>[4. 双向跳转（↑）](#双向跳转)
- <a id="toc-pos-可选加入-path"></a>[5. 可选：加入 PATH](#可选加入-path)
